...
2. **Draft** — the writing engine (currently **{llm["provider"]}**, model
   ...
   Every draft carries YAML frontmatter (scores + sources) and ends with its
   source links. If the model is unreachable, deterministic template drafts
   keep the pipeline alive. Physical-world stories outrank pure-software ones.
